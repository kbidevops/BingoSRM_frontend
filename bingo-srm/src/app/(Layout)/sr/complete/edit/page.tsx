...
export default function SRCompleteEditPage() {
  ...
  const [editForm, setEditForm] = useState<EditFormState>({
    ...
    requestDateTime: "2026-01-07 15:53",
    requestCategory: "일반",
    requestType: "응용프로그램",
    requesterName: "관리자",
    department: "kt",
    ...
    processingDate: "2026-01-07",
    processingTime: "16:08",
