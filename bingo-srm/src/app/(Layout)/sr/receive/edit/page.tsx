      ...
      <Box sx={{ p: 2 }}>
        ...
        >
          <Stack direction="row" spacing={2} alignItems="center">
            ...
            <Button variant="text" size="small" sx={{ color: "text.primary" }}>
            ...
            <Stack spacing={2}>
              ...
              <Box>
                ...
                <Stack direction="row" spacing={1}>
                  <TextField size="small" value="2026-01-21" sx={{ flex: 1 }} />
              ...
              <Box>
                ...
                <TextField
                  ...
                  onChange={(e) =>
                    handleEditFormChange("changeClassification", e.target.value)
                  }
                  SelectProps={{ native: true }}
                >
                  <option value="">
